class CurrencyModel {
  ...
  static const List<CurrencyModel> all = [
    ...
    CurrencyModel(code: 'CAD', name: 'Canadian Dollar', symbol: 'CA\$', flag: '🇨🇦'),
    ...
    CurrencyModel(code: 'KWD', name: 'Kuwaiti Dinar', symbol: 'KD', flag: '🇰🇼'),
    CurrencyModel(code: 'QAR', name: 'Qatari Riyal', symbol: 'QR', flag: '🇶🇦'),
    CurrencyModel(code: 'OMR', name: 'Omani Rial', symbol: 'OMR', flag: '🇴🇲'),
    CurrencyModel(code: 'BHD', name: 'Bahraini Dinar', symbol: 'BD', flag: '🇧🇭'),
    CurrencyModel(code: 'NGN', name: 'Nigerian Naira', symbol: '₦', flag: '🇳🇬'),
    CurrencyModel(code: 'EGP', name: 'Egyptian Pound', symbol: 'E£', flag: '🇪🇬'),
