...
class _SettingPageState extends State<SettingPage> {
  ...
  Widget _buildNavBar(AppColors cl) {
    return Padding(
      ...
      child: Row(
        children: [
          closeButton(context, null, widget.onClose),
          const Spacer(),
          Text(
            context.tr('settings'),
            style: GoogleFonts.poppins(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          hasTerms ? terms.terms : context.tr('not_set_tap'),
                          style: GoogleFonts.poppins(
                            fontSize: 12,
                            color: cl.textSecondary,
                          ),
  ...
  void _showTaxSettingsDialog(AppColors cl, TaxProvider tax) {
    final rateCtrl = TextEditingController(
      text:
          tax.hasTax
              ? tax.rate.toStringAsFixed(
                tax.rate == tax.rate.roundToDouble() ? 0 : 1,
              )
              : '',
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              context.tr('include_year_in_number'),
                              style: GoogleFonts.poppins(
                                fontSize: 14,
                                color: cl.textPrimary,
                              ),
